// Canonical orchestrator-protocol template embedded as a TS
// constant. Source of truth for runtime
// PlotService.defaultTemplate(). MANUAL LOCKSTEP — edits to
// the protocol must be made BOTH here AND in
// <orchestrator-root>/PLOT.md. There is no auto-sync.
